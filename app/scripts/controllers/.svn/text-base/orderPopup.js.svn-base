...
angular.module('conductivEcatalogApp')
    .controller('OrderPopupCtrl', function ($scope, catalog, customer, $timeout, $rootScope, $location, $routeParams) {
        ...
        //TODO Refactor catalog.getPromocodes() to use New models.
        ...
        //TODO Refactor $scope.getCustomerAddresses to use New models.
        ...
        //TODO Refactor $scope.validateEmail to use New models at some point so we can share it across the application.
        ...
        //TODO Refactor catalog.getShipmentMethods() to use New models.
        ...
        //TODO Refactor  $scope.saveFields to use new business models.
      ...
      //TODO May need to refactor $scope.$watch('order' to use new business models.
      ...
      //TODO Refactor	$scope.submitOrder to use new business models.
