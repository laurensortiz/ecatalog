...
angular.module('conductivEcatalogApp').controller('LoginCtrl', function ($rootScope, $scope, indexeddb, authentication, $location, authService, httpCapi, fileSync, $timeout, SyncManager, network) {
    ...
    $scope.loginOnline = function () {
        ...
        authDeferred.done(function () {
            ...
            SyncManager.sync().progress(function (percent) {
            }).then(function () {
